                                ...
                                <tbody>
                                    <?php
                                     ...
                                     '<tr> 
                                        ...
                                        <a  data-bs-toggle="modal" data-bs-target="#exampleModalp'.$index.'">
                                      ...
                                      <!-- Modal -->
                                        <div class="modal fade" id="exampleModalp'.$index.'" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ARE YOU SURE YOU WANT TO DELETE PAYMENT OF '.$row['name'].'?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">CANCEL</button>
                                                <a type="button" class="btn btn-danger"  href="deletep.php?id='.$row['id'].'">DELETE</a>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
