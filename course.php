...
<div style=" width: 99%; margin: auto;" class="container-fluid bg-light">
                        <div class="row mt-4">
                            <div class="col-md d-flex justify-content-between">
                                ...
                                <div class="">
                                <button type="button" class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#exampleModal">ADD COURSE</button>
                                </div>
                            </div>
                        </div>
                        <hr id="hr">
                        <div style="overflow-x: auto;" class="row">
                            <table class="table table-hover table-striped">
                                <tr style="color: #ACACAC;">
                                    <th scope="col" style="color: #acacac;">Teacher Name</th>
                                    <th scope="col" style="color: #acacac;">COURSE DETAIL</th>
                                    <th scope="col" style="color: #acacac;">INFORMATION</th>
                                    <th scope="col"></th>
                                </tr>
                                </thead>
                                <tbody>
                                    <?php
                                     ...
                                     '<tr> 
                                        ...
                                        <td>
                                        <a href="editec.php?id='.$row['id'].'"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#exampleModals'.$index.'">
                                      ...
                                      <!-- Modal -->
                                      <div class="modal fade" id="exampleModals'.$index.'" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog">
                                          <div class="modal-content">
                                          <div class="modal-header">
                                              <h5 class="modal-title" id="exampleModalLabel">DELETE CONFITMATION</h5>
                                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                          </div>
                                          <div class="modal-body">
                                              ARE YOU SURE YOU WANT TO DELETE COURSE OF '.$row['name'].' ?
                                          </div>
                                          <div class="modal-footer">
                                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">CANCEL</button>
                                              <a type="button" class="btn btn-danger" href="deletec.php?id='.$row['id'].'">DELETE</a>
                                          </div>
                                          </div>
                                      </div>
                                      </div>
