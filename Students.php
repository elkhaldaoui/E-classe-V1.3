                                ...
                                <tbody>
                                    <?php
                                     ...
                                     '<tr> 
                                        ...
                                        <td>
                                        <a href="edites.php?id='.$row['id'].'"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <!-- Modal -->
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a type="button" class="btn btn-danger" href="deletes.php?id='.$row['id'].'">DELETE</a>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
